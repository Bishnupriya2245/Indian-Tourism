		  ...
		  <div class="container">
			 <div class="top-nav">
                        ...
                        <li><a href="category.php" onclick="javascript:window.open('category.php','_self')">Category</a></li>
							 <li><a href="index.php#section-5"   onclick="javascript:window.open('index.php#section-5','_self')">                            Map</a></li>
							 <li><a href="index.php#section-6"   onclick="javascript:window.open('index.php#section-6','_self')">                              Contact</a></li>
							 <li><a href="user.php"   onclick="javascript:window.open('user.php','_self')" >login</a></li>
